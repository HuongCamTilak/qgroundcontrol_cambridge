...
void Vehicle::_commonInit(LinkInterface* link)
{
    ...
    _odometryFactGroup              = new VehicleOdometryFactGroup(this);
    ...
    _addFactGroup(_odometryFactGroup,          _odometryFactGroupName);
...
FactGroup* Vehicle::odometryFactGroup()             { return _odometryFactGroup; }
